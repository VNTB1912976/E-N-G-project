...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const BreathPageWidget() : const LoginPageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'BreathPage',
          path: '/breathPage',
          builder: (context, params) => BreathPageWidget(
        ...
        FFRoute(
          name: 'ConnectionDevicePage',
          path: '/connectionDevicePage',
          builder: (context, params) => ConnectionDevicePageWidget(
        ...
        FFRoute(
          name: 'SchedulePage',
          path: '/schedulePage',
          builder: (context, params) => const SchedulePageWidget(),
        ),
        FFRoute(
